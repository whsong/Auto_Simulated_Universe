...
class Config:
    def __init__(self):
        ...
        # 远程角色列表
        # 缇宝虽然是远程角色，但普攻位移较大，不适合寻路使用。
        self.long_range_list = ['丹恒饮月','克拉拉','青雀','波提欧','托帕账账','彦卿','符玄','砂金','三月七','娜塔莎','阮梅',
                                '知更鸟','布洛妮娅','艾丝妲','驭空','黑天鹅','瓦尔特杨','佩拉','大黑塔','忘归人','星期日','灵砂','风堇']
        # TODO:all_list只见于update_skill()
        # character_prior来自characters.csv
        self.all_list = ['流萤','黄泉','波提欧','真理医生','丹恒饮月','瓦尔特杨','克拉拉','银枝','刃','希儿','景元','镜流','卡芙卡',
                         '托帕账账','黑天鹅','翡翠','云璃','砂金','椒丘','彦卿','姬子','杰帕德','藿藿','白露','阿兰','素裳','加拉赫',
                         '知更鸟','阮梅','布洛妮娅','花火','符玄','银狼','罗刹','寒鸦','卢卡','桂乃芬','虎克','艾丝妲','米沙','佩拉',
                         '黑塔','三月七','停云','桑博','雪衣','青雀','玲可','驭空','娜塔莎','希露瓦','大黑塔','忘归人','星期日','灵砂',
                         '缇宝','风堇']
